module Criteria
  ...
  module Filterable
    ...
    def expression_for( expression_name, attribute=nil, *args)
      ...
      raise "#{attribute.to_s} is not a column on model class #{table_alias.model_class.name}" unless attribute and table_alias.model_class.column_methods_hash[attribute]
